...
//                     attribute_value: Array.isArray(proToEdit.attribute_value) ? proToEdit.attribute_value : [],                    color: proToEdit.color || "",
...
//                     dispatch(GetAttributeValues(id,proToEdit.attribute));
//                 }
//             }
//         }
...
//         if (products?.products && id) {
//             const proToEdit = products.products.find((prod) => prod._id === id);
//             console.log(proToEdit, 'Full proToEdit object');
//             console.log(proToEdit?.attribute, 'attribute from proToEdit');
//             console.log(proToEdit?.attribute_value, 'attribute_value from proToEdit');
//                     }
//     }, [products?.products, id, dispatch]);
