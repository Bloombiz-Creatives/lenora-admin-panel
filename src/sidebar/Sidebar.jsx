...
//       subItems: [
//         { text: 'Home', route: '/dashboard' },
//         { text: 'Shop', route: '/dashboard/shop' },
//       ],
//     },
//     { text: 'Brands', route: '/dashboard/brands', icon: cat1 },
//     { text: 'Categories', route: '/dashboard/categories', icon: cat1 },
//   ];
...
//             {open && (
//               <img src={logo} alt="Lenora" className="h-8 cursor-pointer" onClick={() => navigate('/dashboard')} />
//             )}
//           </div>
//         </DrawerHeader>
//         <List>
...
//                     px: 2.5,
//                   }}
//                   onClick={() => item.subItems ? null : navigate(item.route)}
//                 >
//                   <ListItemIcon
//                     sx={{
//                       minWidth: 0,
...
//                   </ListItemIcon>
//                   <ListItemText primary={item.text} sx={{ opacity: open ? 1 : 0, color: 'white' }} />
//                   {item.subItems && open && <ExpandMoreIcon sx={{ color: 'white' }} />}
//                 </ListItemButton>
//               </ListItem>
//               {item.subItems && open && (
